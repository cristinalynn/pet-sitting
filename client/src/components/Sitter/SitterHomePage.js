...
function SitterHomePage() {
  ...
  const [availability, setAvailability] = useState("Full-Time, Part-Time, Occasionally");
  ...
  return (
    <div className="sitter-home-page">
      ...
      <header>
        ...
        <h2>About Me</h2>
        <p>Hello! My name is Cristina, and I am a passionate pet sitter. I have over 5 years of experience providing care for pets, from dog walking to day care and boarding services. I love animals, and my mission is to ensure your pet feels safe, loved, and happy while in my care!</p>
      </section>
